    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb align-items-center mb-0 lh-1">
            ...
            <li class="breadcrumb-item active">
                <span class="text-secondary">Edit Resource</span>
            </li>
        </ol>
    </nav>
</div>
...
{{-- FORM --}}
<form action="{{ route('admin.resources.update',$resource->id) }}"
      method="POST"
    ...
    <div class="row">
        ...
        <div class="col-lg-8">
            <div class="card bg-white p-20 rounded-10 border border-white mb-4">
                <h3 class="mb-20">Edit Resource</h3>
                ...
                <div class="form-group mb-20">
                    ...
                    <textarea name="description"
                              class="form-control"
                              style="height:163px;">{{ old('description',$resource->description) }}</textarea>
                </div>

                {{-- Existing Image --}}
                @if($resource->image)
                <div class="mb-3">
                    <label class="label fs-16">Current Image</label><br>
                ...
                <div class="form-group mb-4 only-file-upload">
                    <label class="label fs-16 text-secondary">Change Cover Image</label>
                ...
                @if($resource->pdf)
                <div class="mb-3">
                    <label class="label fs-16">Current PDF</label><br>
                    <a href="{{ asset('storage/'.$resource->pdf) }}"
                       target="_blank"
                ...
                {{-- Upload PDF --}}
                <div class="form-group mb-4 only-file-upload">
                    <label class="label fs-16 text-secondary">Change PDF File</label>
                    <div class="form-control h-100 text-center position-relative p-4 p-lg-5">
                        <div class="product-upload">
                            <label class="file-upload mb-0">
            ...
            <div class="card bg-white p-20 rounded-10 border border-white mb-4">
                ...
                <div class="mb-20">
                    ...
                    <select class="form-select" name="lang">
                        <option value="en" {{ old('lang', $resource->lang) === 'en' ? 'selected' : '' }}>English</option>
                        <option value="fr" {{ old('lang', $resource->lang) === 'fr' ? 'selected' : '' }}>French</option>
                    </select>
                </div>
