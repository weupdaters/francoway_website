          ...
          <div class="card bg-white p-20 rounded-10 border border-white mb-4">
            ...
            <div class="mb-20">
              ...
              <select class="form-select mb-20" name="has_custom_prompt" id="has_custom_prompt_select">
                <option value="0" {{ old('has_custom_prompt') == '0' ? 'selected' : '' }}>No</option>
                <option value="1" {{ old('has_custom_prompt') == '1' ? 'selected' : '' }}>Yes</option>
              </select>
            </div>

            <div class="mb-20" id="custom_prompt_container" style="display: none;">
              <label class="label fs-16 mb-2">Custom  Prompt</label>
              <textarea name="custom_prompt" class="form-control" style="height:120px;" placeholder="Enter the custom AI prompt for this course...">{{ old('custom_prompt') }}</textarea>
            </div>
