...
<body class="bg-[#F5F8FC] text-gray-800 min-h-screen flex items-center justify-center p-4 relative overflow-hidden">
                    ...
                    <div class="space-y-1.5">
                        ...
                        <div class="relative">
                            <input 
                                ...
                                placeholder="•••••••••" 
                                required 
                                class="w-full pl-4 pr-12 py-2.5 bg-gray-50/50 border border-gray-200 rounded-xl text-sm focus:outline-none focus:border-brandRed focus:bg-white transition-all duration-350 shadow-sm"
                            >
                            <!-- Password visibility eye outline -->
                            <button 
                                type="button" 
                                id="toggle-password"
                                class="absolute inset-y-0 right-0 pr-3.5 flex items-center text-gray-400 hover:text-brandRed transition-colors focus:outline-none"
                            >
                                <!-- Eye Icon (Show) -->
                                <svg id="eye-icon" class="w-5 h-5" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M2.036 12.322a1.012 1.012 0 010-.644C3.76 6.969 8.21 3 13.5 3c5.29 0 9.74 3.969 11.464 8.678a1.012 1.012 0 010 .644C23.24 17.03 18.79 21 13.5 21c-5.29 0-9.74-3.969-11.464-8.678z" />
                    ...
                    <div class="space-y-1.5">
                        ...
                        <div class="relative">
                            ...
                            >
                                ...
                                <!-- Eye Slash Icon (Hide) -->
                                <svg id="eye-slash-icon-confirm" class="w-5 h-5 hidden" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M3.98 8.223A10.477 10.477 0 001.934 12C3.226 16.338 7.244 19.5 12 19.5c.993 0 1.953-.138 2.863-.395M6.228 6.228A10.45 10.45 0 0112 4.5c4.756 0 8.773 3.162 10.065 7.498a10.523 10.523 0 01-4.293 5.774M6.228 6.228L3 3m3.228 3.228l3.65 3.65m7.822 7.822L21 21m-3.228-3.228l-3.65-3.65m0 0a3 3 0 10-4.243-4.243m4.242 4.242L9.88 9.88" />
                                </svg>
                            </button>
                        </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            if (toggleConfirmButton && passwordConfirmInput) {
