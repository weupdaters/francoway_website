      ...
      <nav aria-label="breadcrumb">
        <ol class="breadcrumb align-items-center mb-0 lh-1">
          <li class="breadcrumb-item">
            <a href="{{ route('users.dashboard') }}" class="d-flex align-items-center text-decoration-none">
    ...
    <div class="card bg-white rounded-10 border-0 mb-4">
      ...
      <div class="d-flex justify-content-between align-items-center flex-wrap gap-3 p-20 border-bottom">
        ...
        <div class="d-flex gap-3">
          <a href="{{ route('users.courses.index') }}" class="btn btn-outline-secondary">
            ← Back to Courses
          </a>
        </div>
      </div>
          ...
          <div class="col-xxl-3 col-xl-4 col-lg-6 col-md-6">
            <div class="card h-100 border-0 shadow-sm rounded-12 d-flex flex-column">
              ...
              <div class="border-top py-3 text-center">
                <a href="{{ route('users.lessons.show', [$course->id, $lesson->id]) }}" class="btn btn-sm btn-primary">
                  View Lesson
                </a>
              </div>
