    ...
    <div class="row g-4">
        ...
        <div class="col-lg-3">
            <div class="card p-3 h-100">
                ...
                <a href="{{ route('teacher.course_lessons.index', $lesson->course_id) }}"
            ...
            <div class="card p-3">
                ...
                @foreach($lesson->comments as $comment)
                    <div class="border rounded p-3 mb-3">
                        ...
                        {{-- TEACHER REPLY --}}
                        <form method="POST"
                              action="{{ route('teacher.comment.reply', $comment->id) }}"
                              class="mt-2">
                            @csrf
                ...
                {{-- ADD COMMENT --}}
                <form method="POST"
                      action="{{ route('teacher.lesson.comment', $lesson->id) }}">
                    @csrf
                    <textarea name="comment"
                              class="form-control mb-2"
                              rows="3"
